...
/**
 * The CommandLine object is basically the game without the GUI.
 * Switch statements are used so that the player can keep using actions etc.
 *
 */
public class CommandLine {
    ...
    public void setUp() {
        ...
        System.out.println("You're spaceship is named: "+spaceShipName + " and you require: "+game.getSpaceShip().getPiecesRequired()+" pieces in order to win the game");
        ...
        if (actionedMember.hasActionsLeft()) {
            switch (selectedCrewAction) {
                ...
                case 3:
                    ...
                    game.getSpaceShip().incrementShieldLevel(20);
