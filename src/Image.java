/**
 * The Image object is used to get image paths
 * for all images used in the game
 */
public class Image {
     ...
     * @return string The image path.
     */
    public static String getFoodImagePathSmall(Food food) {
        return String.format("images/%s_small.png", food.getType().toLowerCase());
    }
     ...
     * @return string The image path.
     */
    public static String getMedicalSupplyImagePathSmall(MedicalSupply medicalSupply) {
        return String.format("images/%s_small.jpg", medicalSupply.getType().toLowerCase());
    }
}