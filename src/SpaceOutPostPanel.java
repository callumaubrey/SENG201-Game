...
/**
 * This is the main panel for the inventory
 * and where the user can purchase medical supplies and foods
 */
public class SpaceOutPostPanel extends JPanel {
    ...
    private void refreshInventoryPanel() {
        ...
        for (Food food: spaceOutPost.getFoods()) {
            ...
            lblFoodImage.setIcon(new ImageIcon(SpaceOutPostPanel.class.getResource(Image.getFoodImagePathSmall(food))));
        ...
        for (MedicalSupply medicalSupply: spaceOutPost.getMedicalSupplies()) {
            ...
            lblMedicalSupplyImage.setIcon(new ImageIcon(SpaceOutPostPanel.class.getResource(Image.getMedicalSupplyImagePathSmall(medicalSupply))));
    ...
    private void refreshMedicalSuppliesPanel() {
        ...
        for (MedicalSupply medicalSupply: spaceOutPost.getMedicalSupplies()) {
            ...
            JLabel lblMedicalSupplyImage = new JLabel("");
            lblMedicalSupplyImage.setIcon(new ImageIcon(SpaceOutPostPanel.class.getResource(Image.getMedicalSupplyImagePath(medicalSupply))));
            lblMedicalSupplyImage.setBorder(new LineBorder(new Color(0, 0, 0)));
    ...
    private void refreshFoodsPanel() {
        ...
        for (Food food: spaceOutPost.getFoods()) {
            ...
            JLabel lblFoodImage = new JLabel("");
            lblFoodImage.setIcon(new ImageIcon(SpaceOutPostPanel.class.getResource(Image.getFoodImagePath(food))));
            lblFoodImage.setBorder(new LineBorder(new Color(0, 0, 0)));
