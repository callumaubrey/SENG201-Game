...
/**
 * The SetUpScreen is the screen used to
 * choose a spaceship and team name, select
 * the number of days and character
 * and choose all the characters you want to play
 * It also displays information on how to play the game
 */
public class SetUpScreen {
	...
	*/
	public void addChooseCharacterPanel() {
		...
		lblMemberImage.setIcon(new ImageIcon(SetUpScreen.class.getResource(Image.getCrewMemberImagePath(barter))));
		...
		type.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblMemberImage.setIcon(new ImageIcon(SetUpScreen.class.getResource(imagePath)));
	...
	public void addGameInformationPanel() {
		...
		JTextArea textArea = new JTextArea(
			...
			"Random events can occur whilst out on your space adventure, when continuing to the next day your crew may get attacked by Alien Pirates who will steal a random item from your ship." + 
			"One of your crew members may get a bad case of the Space Plague, which means the crew member will lose extra health every day, but can be cured by the Space Plague Cure."+
			"Be careful when travelling to another planet because there are many asteroid belts that can do serious damage to your ship so remember to repair it." +
			"Good luck!", 6, 20);
