/**
 * The Game instance runs the game
 * It acts as a window manager and opens/closes 
 * each window. This also passes each window it's instance
 * which carrys the Game Environment class.
 */
public class Game {
    ...
    /**
     * Closes defeat and victory screens and opens set up screen
     */
    public void closeDefeatScreen(DefeatScreen screen) {
        screen.finishedWindow();
        runSetUpScreen();
    }
     ...
     * Closes defeat and victory screens and opens set up screen
     */
    public void closeVictoryScreen(VictoryScreen screen) {
        screen.finishedWindow();
        runSetUpScreen();
    }
