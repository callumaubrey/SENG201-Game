...
/**
 * This is the biggest panel and handles all the 
 * actions a crew member can make during the game.
 */
public class CrewPanel extends JPanel {
    ...
    private void refreshCrewDetailsPanel() {
        ...
        for (CrewMember member: crew.getMembers()) {
            ...
            lblMemberImage.setIcon(new ImageIcon(CrewPanel.class.getResource(Image.getCrewMemberImagePath(member))));
    ...
    private void refreshNewFoodPanel() {
        ...
        for (Food food : spaceOutPost.getFoods()) {
            ...
            lblFoodImage.setIcon(new ImageIcon(CrewPanel.class.getResource(Image.getFoodImagePath(food))));
    ...
    public void refreshNewMedicalItemPanel() {
        ...
        for (MedicalSupply medicalSupply : spaceOutPost.getMedicalSupplies()) {
            ...
            lblMedicalSupplyImage.setIcon(new ImageIcon(CrewPanel.class.getResource(Image.getMedicalSupplyImagePath(medicalSupply))));
        ...
        JPanel applyFoodPanel = new JPanel();
        applyFoodPanel.setLayout(null);
        JButton applyMedicalItemBtn = new JButton("Apply Medical Supply");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (membersBtnGroupOne.getSelection() == null || membersBtnGroupTwo.getSelection() == null || 
                    ...
                    if (selectedMemberOne.getName() == selectedMemberTwo.getName()) {
                        ...
                        boolean hasHitAsteroidBelt = environment.doAsteroidBelt();
                        if (hasHitAsteroidBelt) {
                            JOptionPane.showMessageDialog(null, "You have hit an asteroid belt. Space Ship health is now: " + environment.getSpaceShip().getShieldHealth());
                        }

                        if (!isDefeated && !hasHitAsteroidBelt) {
    ...
    private JPanel fillPlanetPanelAndButtonGroup(Planet planet, ButtonGroup buttonGroup) {
        ...
        lblPlanetImage.setIcon(new ImageIcon(CrewPanel.class.getResource(Image.getPlanetImagePath(planet))));
